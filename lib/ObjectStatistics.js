    ...
    this.lazyPluck = (obj) => {
        for (const property in obj) {
            ...
            if (this.memory[property]) {
                ...
                this.memory[property].sum += value
                this.memory[property].totalPow2 += Math.pow(value, 2)
                this.memory[property].std = movingStd(this.memory[property].totalPow2, this.memory[property].sum, this.memory[property].count)
                this.memory[property].std2 = onlineVariance(value, this.memory[property].count, this.memory[property].std2['mean'], this.memory[property].std2['M2'])
